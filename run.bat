...
set SRC=..\src\acts.cpp ..\src\arrs.cpp ..\src\datas.cpp ..\src\linalg.cu ..\src\losses.cpp ..\src\lyrs.cu ..\src\main.cpp ..\src\math.cu ..\src\preproc.cpp ..\src\rd.cpp ..\src\tensor.cpp
