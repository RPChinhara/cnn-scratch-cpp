...
set SRC=..\src\acts.cpp ..\src\arrs.cpp ..\src\datasets.cpp ..\src\linalg.cu ..\src\losses.cpp ..\src\lyrs.cpp ..\src\main.cpp ..\src\math.cu ..\src\rand.cpp ..\src\renderer.cpp ..\src\strings.cpp ..\src\tensor.cpp ..\src\window.cpp
