...
std::vector<ten> rnn::forward(const ten &x)
{
    ...
    for (auto i = 0; i < seq_length; ++i)
    {
        ...
        // 8316 = 1 8316 8316 1, 1 50 = 8316 50 -> 8316 50, 50 50 = 8316 50 ->
        // 8316 50, 50 1 = 8316 1 50 8316, 8316 1 = 50 1 -> 50 50, 50 1 = 50 1
        // -> 1 50, 50 1 = 1 1 I think this is wrong because when you think
        // about it it's weird that getting only one ouput even thougth I input
        // 8316 batches.
