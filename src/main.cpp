...
//  tf.keras.datasets.imdb.load_data() as it is cumbersome, and the datasets have nothing to do with the order. The
//  order of the dataset from tf.keras.datasets.imdb.load_data() and the dataset downloaded from the link on the
//  tf.keras.datasets.imdb.load_data() don't match.
