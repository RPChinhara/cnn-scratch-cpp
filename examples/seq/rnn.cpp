...
void rnn_train(const tensor& x_train, const tensor& y_train) {
    for (auto i = 1; i <= epochs; ++i) {
        ...
        // TODO: I have to use sum() for 'd_loss_d_y' in gru.cpp and lstm.cpp as well. However, I'm not sure as I might stop daclaring biases as they are now e.g., (hidden_size, 1.
        // 2, 2, 2, 2
        // 4, 4, 4, 4
        // 16
